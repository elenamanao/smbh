...
if mode == 'no_mask':
    ...
    for s in np.arange(n_trials):
        ra_scramble = scramble.scramble_ra(ra_true, s)
    ...
    for s in np.arange(n_trials):
        ra_scramble, ra_true, dec_true = scramble.mask_hotspot_and_scramble(ra_true, dec_true, s,
    ...
    for s in np.arange(n_trials):
        ra_scramble, dec_scramble = scramble.scramble_and_mask_hotspot(ra_true, dec_true, s,
                                                                pao_hotspot_ra, pao_hotspot_dec, pao_hotspot_r )
